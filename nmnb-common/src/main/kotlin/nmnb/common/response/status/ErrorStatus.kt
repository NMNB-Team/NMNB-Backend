...
enum class ErrorStatus(
    ...
    // S3
    S3_DOWNLOAD_POST_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "S3500", "S3에서 영상을 다운로드하는 데 실패했습니다"),
    S3_UPLOAD_PROFILE_IMAGE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "S3501", "프로필 이미지 업로드 중 오류가 발생했습니다."),
    ;
